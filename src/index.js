...
const rhythm = function(options) {
  ...
  return function(lines, fontSize, offset) {
    ...
    if (fontSize == null) { fontSize = options.baseFontSize; }
...
const adjustFontSizeTo = function(toSize, lines, fromSize, options) {
  if (fromSize == null) { fromSize = options.baseFontSize; }
...
module.exports = function(options) {
  ...
  return {
    ...
    establishBaseline() { return establishBaseline(options); },
    linesForFontSize(fontSize) { return linesForFontSize(fontSize, options); },
    adjustFontSizeTo(toSize, lines, fromSize) {
      if (lines == null) { lines = "auto"; }
